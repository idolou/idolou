...
- **[SpreadSheetApp](https://github.com/idolou/Shareable-SpreadSheetApp)** - C# (Distributed Systems)
- **[Farmers Market Management](https://github.com/idolou/Farms-market-management)** - C++ (Memory Management, STL)
